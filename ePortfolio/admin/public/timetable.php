                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered border text-nowrap mb-0" >
                                                ...
                                                $query = "SELECT * FROM timetable INNER JOIN user ON timetable.userid = user.userid INNER JOIN subject ON timetable.subjectid = subject.subjectid INNER JOIN semester ON timetable.semesterid = semester.semesterid";
