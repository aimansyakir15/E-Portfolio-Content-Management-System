                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered border text-nowrap mb-0" >
                                                ...
                                                $query = "SELECT * FROM attendance INNER JOIN user ON attendance.userid = user.userid INNER JOIN subject ON attendance.subjectid = subject.subjectid INNER JOIN semester ON attendance.semesterid = semester.semesterid";
