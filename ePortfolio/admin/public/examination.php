                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered border text-nowrap mb-0" >
                                                ...
                                                $query = "SELECT * FROM examination INNER JOIN user ON examination.userid = user.userid INNER JOIN subject ON examination.subjectid = subject.subjectid INNER JOIN semester ON examination.semesterid = semester.semesterid";
