                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">List of Semester</h3>
                                    </div>
                                    <div class="card-body">
                                        <a href="config?addsemester=true"><button class="btn btn-primary mb-4">Add New Semester</button></a>
                                            ...
                                            <table class="table table-bordered border text-nowrap mb-0" >
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="config.php?semesterid=<?php echo $row['semesterid']; ?>"><button class="btn btn-success-light">Edit</button></a>
                                                            <a href="../private/delete.php?semesterid=<?php echo $row['semesterid']; ?>"><button class="btn btn-danger-light">Delete</button></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
