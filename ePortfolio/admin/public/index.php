            ...
            <div class="main-content app-content mt-0">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        $query = mysqli_query($db , "SELECT * FROM assignmentproject");
                        $rowcount = mysqli_num_rows($query);
                        $query1 = mysqli_query($db , "SELECT * FROM cis");
                        $rowcount1 = mysqli_num_rows($query1);
                        $query2 = mysqli_query($db , "SELECT * FROM cst");
                        $rowcount2 = mysqli_num_rows($query2);
                        $query3 = mysqli_query($db , "SELECT * FROM examination");
                        $rowcount3 = mysqli_num_rows($query3);
                        $query4 = mysqli_query($db , "SELECT * FROM mtp");
                        $rowcount4 = mysqli_num_rows($query4);
                        $query5 = mysqli_query($db , "SELECT * FROM qst");
                        $rowcount5 = mysqli_num_rows($query5);
                        $query6 = mysqli_query($db , "SELECT * FROM sow");
                        $rowcount6 = mysqli_num_rows($query6);
                        $query7 = mysqli_query($db , "SELECT * FROM timetable");
