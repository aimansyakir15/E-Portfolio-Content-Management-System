                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="config?addsubject=true"><button class="btn btn-primary mb-4">Add New Subject</button></a>
                                            ...
                                            <table class="table table-bordered border text-nowrap mb-0" >
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="config.php?subjectid=<?php echo $row['subjectid']; ?>"><button class="btn btn-success-light">Edit</button></a>
                                                            <a href="../private/delete.php?subjectid=<?php echo $row['subjectid']; ?>"><button class="btn btn-danger-light">Delete</button></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
