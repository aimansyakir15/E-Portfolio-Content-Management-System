                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="config?attendance=true"><button class="btn btn-primary mb-4">Add File</button></a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered border text-nowrap mb-0" >
                                                ...
                                                $query = "SELECT * FROM attendance INNER JOIN user ON attendance.userid = user.userid INNER JOIN subject ON attendance.subjectid = subject.subjectid INNER JOIN semester ON attendance.semesterid = semester.semesterid WHERE user.userid = '$check'";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="../private/delete.php?attendanceid=<?php echo $row['attendanceid']; ?>"><button class="btn btn-danger-light">Delete</button></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
