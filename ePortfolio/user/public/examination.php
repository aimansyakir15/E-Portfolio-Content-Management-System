                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="config?exam=true"><button class="btn btn-primary mb-4">Add File</button></a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered border text-nowrap mb-0" >
                                                ...
                                                $query = "SELECT * FROM examination INNER JOIN user ON examination.userid = user.userid INNER JOIN subject ON examination.subjectid = subject.subjectid INNER JOIN semester ON examination.semesterid = semester.semesterid WHERE user.userid = '$check'";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="../private/delete.php?examid=<?php echo $row['examid']; ?>"><button class="btn btn-danger-light">Delete</button></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
